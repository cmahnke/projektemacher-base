...
wget https://github.com/libjxl/libjxl/releases/download/v0.10.3/jxl-debs-amd64-ubuntu-22.04-v0.10.3.tar.gz
tar xzf jxl-debs-amd64-ubuntu-22.04-v0.10.3.tar.gz

sudo apt install -y -f ./libjxl_0.10.3_amd64.deb
sudo apt install -y -f ./jxl_0.10.3_amd64.deb
sudo apt install -y -f ./libjxl-dev_0.10.3_amd64.deb
